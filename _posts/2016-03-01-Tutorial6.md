...
### What you should see
Download [Argon3](https://itunes.apple.com/us/app/argon3/id944297993?ls=1&mt=8) and [Try Now]({{ site.baseurl }}code/argon.js/dist/argon-tutorials/tutorial6-Vuforia)
...
We add light to our scene, because we will have a 3D object that needs to be lighted. These are three.js objects and methods, which you can find documented at [http://threejs.org/docs/](http://threejs.org/docs/):
