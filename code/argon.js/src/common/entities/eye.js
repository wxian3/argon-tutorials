...
import {isChannel} from '../Platform'
import device from './device'

const eyeEntity = dataSource.entities.add({
  id: 'EYE',
  name: 'EYE'
})
...
eyeEntity.position = new Cesium.ConstantPositionProperty(Cesium.Cartesian3.ZERO, device)
eyeEntity.orientation = new Cesium.ConstantProperty(Cesium.Quaternion.IDENTITY)

if (isChannel) {
  dataSource.subscribeToEntityById('EYE')
}

export default eyeEntity
